...
import { ESTATE_URI_URL } from '../../config';
      ...
      <Center py={12}>
        <Box
          ...
          <Box pt={14} align={'center'}>
            ...
            <Button disabled={!viewBtn} w="100%" mt="2" variant="solid" colorScheme="purple" rightIcon={<BsBox />} size={'sm'} onClick={()=>window.open("/estatevr-view?id="+tokenId)}>View VR Content</Button>
